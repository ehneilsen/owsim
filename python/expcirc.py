"""Calculate circumstances for a set of exposures"""
import argparse
...
def exposure_circumstances(exposures,
    ...
    calc_coord_brightness = np.vectorize(SkyBrightnessSource(sky_data_path).coord_brightness)
...
def main():
    ...
    parser.add_argument('circumstances', help='file to which to write exposure circumstances')
